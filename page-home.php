...
<body>
  ...
  <header>
    <nav class="navbar navbar-expand-lg fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#"><img src="<?php  echo get_theme_root_uri(); ?>/Plure-Site/assets/logoLight.svg" height="60px" alt="Logo da PLURE"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#staticBackdrop" data-bs-toggle="modal" data-bs-target="#staticBackdrop">FAQ</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-12 col-sm-12 col-md-8 col-lg-9">
            ...
            <p>Se sua empresa tiver uma marca sólida, honesta e cheia de propósito, consequentemente terá forte
              ...
              decisão.</p>
            <p>Uma vez atribuída uma imagem a sua marca, se essa percepção for positiva, o seu público terá preferência
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-12 col-md-8">
            <ol>
              ...
              <li>Com o Registro você irá adquirir um que garante o direito de e uso exclusivo de sua marca em
                território nacional.</li>
              <li>O Registro de MARCAS pode proteger o nome, os sinais distintivos das letras,números, figuras e tudo o
                que faz parte da composição da sua marca.</li>
              <li>A MARCA concentra todos os resultados da empresa. Os investimentos em marketing, ou das vendas, a
                avaliação dos produtos ou serviços e a confiança dos clientes são atribuídos ao nome da empresa, ou
                seja, a sua MARCA.</li>
              <li>Para que você possa ter exclusividade no mercado, evitando que terceiros utilizem a sua MARCA,
                garantindo que somente você, o detentor do certificado de registro da MARCA, possa usar, gozar, fruir e
  ...
  <section>
    ...
    <div class="container-fluid py-5 hero3 text-center">
      <div class="container">
        ...
        <div class="divisorLightCenter"></div>
        <p>Caso sua MARCA seja INDEFERIDA, damos entrada em outro nome escolhido por você, sem a cobrança de honorários.
          É preciso pagar apenas as taxas do Governo. A garantia é válida para UMA CLASSE, havendo interesse no registro
          em mais classes, consultar valor de honorários.</p>
      </div>
    </div>
  </section>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <img src="assets/logoDark.svg" height="60px" alt="">
        ...
        <div class="modal-body text-start">
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq1" role="button" aria-expanded="false"
            aria-controls="faq1"><b>O que é marca?</b></a class="buttonThree">
          <div id="faq1" class="collapse p-4">
            <p>Marca é todo sinal distintivo, visualmente perceptível, que identifica e distingue produtos e serviços,
              bem como certifica a conformidade dos mesmos com determinadas normas ou especificações técnicas. A marca
              registrada garante ao seu proprietário o direito de uso exclusivo no território nacional em seu ramo de
              atividade econômica. Ao mesmo tempo, sua percepção pelo consumidor pode resultar em agregação de valor aos
          ...
          <div id="faq2" class="collapse p-4">
            <p>Um pedido de registro de marca é feito pelo preenchimento de formulário, que deve ser entregue junto com
              o arquivo da imagem e procuração (se houver) ao INPI. Este processo é realizado por nós e você receberá um
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq3" role="button" aria-expanded="false"
            aria-controls="faq3"><b>A busca prévia é obrigatória?</b></a>
          <div id="faq3" class="collapse p-4">
            <p>Não. Entretanto, é aconselhável ao interessado realizá-la antes de efetuar o depósito, na classe
              (atividade) que pretende registrar seu produto ou serviço, para verificar se já existe marca anteriormente
              depositada ou registrada. Aqui conosco, oferecemos gratuitamente este serviço, pois entendemos a sua
              importância.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq4" role="button" aria-expanded="false"
            aria-controls="faq4"><b>O que é registrável como marca?</b></a>
          <div id="faq4" class="collapse p-4">
            <p>A marca pode ser conferida para um produto ou para um serviço, contanto que tenha poder de distingui-lo
              de outros semelhantes ou afins. São registráveis como marca sinais visuais. Portanto, a lei brasileira não
          ...
          <div id="faq5" class="collapse p-4">
            <p>Sim. Você pode fazer o pedido de marca diretamente no site INPI. Entretanto, nós aconselhamos fortemente
              que faça este processo junto à um de nossos especialistas, uma vez que existem centenas de detalhes
              administrativos, técnicos e jurídicos envolvidos em um registro e se não forem bem orientados e conduzidos
              no pedido, você poderá estar jogando dinheiro fora ou até mesmo tendo uma falsa impressão de que sua marca
              está protegida contra o uso indevido de terceiros.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq6" role="button" aria-expanded="false"
            aria-controls="faq6"><b>Quais são os direitos e deveres do titular de uma marca?</b></a>
          <div id="faq6" class="collapse p-4">
            <p>A marca registrada garante a propriedade e o uso exclusivo em todo o território nacional por dez anos. O
              titular deve mantê-la em uso e prorrogá-la de dez em dez anos.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq7" role="button" aria-expanded="false"
            aria-controls="faq7"><b>Pessoa física pode requerer o registro?</b></a>
          <div id="faq7" class="collapse p-4">
            <p>A pessoa física pode requerer o registro de marca, desde que comprove a atividade exercida, através de
              documento comprobatório, expedido pelo órgão competente. Verifica-se a habilitação profissional diante do
              órgão ou entidade responsável pelo registro, inscrição ou cadastramento.</p>
          </div>
          ...
          <div id="faq8" class="collapse p-4">
            <p>Possuímos uma plataforma tecnológica que faz a leitura detalhada de todos os processos registrados no
              INPI e todas as suas atualizações, garantindo a você que nenhuma atualização do seu processo, oposição ao
              seu registro ou colidência de pedido de registro por terceiros possa ser feito sem que sejamos avisados e
          ...
          <div id="faq9" class="collapse p-4">
            <p>O registro da marca extingue-se pela expiração do prazo de vigência; pela renúncia (abandono voluntário
              do titular ou pelo representante legal); pela caducidade (falta de uso da marca) ou pela inobservância do
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq10" role="button" aria-expanded="false"
            aria-controls="faq10"><b>Quando pode ser efetivada a transferência de titularidade?</b></a>
          <div id="faq10" class="collapse p-4">
            <p>A petição de transferência pode ser efetivada a qualquer momento depois do depósito do pedido de registro
              de marca. É necessário pagar a Guia de Recolhimento da União (GRU) referente ao serviço "anotação de
              transferência de titular" em nome do cessionário. Após o pagamento, deve ser preenchido o formulário
              eletrônico no e-Marcas do INPI. <br> Realizamos este serviço para você, basta solicitar mais informações.
            </p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq11" role="button" aria-expanded="false"
            aria-controls="faq11"><b>Qual é o tempo de duração de um registro de marca?</b></a>
          <div id="faq11" class="collapse p-4">
            <p>O registro de marca vigora pelo prazo de dez anos, contados da data da concessão, prorrogáveis por
              períodos iguais e sucessivos. O pedido de prorrogação deverá ser formulado durante o último ano de
              vigência do registro, mediante pagamento.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq12" role="button" aria-expanded="false"
            aria-controls="faq12"><b>O que é direito do usuário anterior?</b></a>
          <div id="faq12" class="collapse p-4">
            <p>Toda pessoa que, de boa-fé, usava no País, há pelo menos seis meses, marca idêntica ou semelhante, para a
              mesma atividade ou atividades afins, pode reivindicar o direito de precedência ao registro.</p>
          </div>
          <hr>
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq13" role="button" aria-expanded="false"
            aria-controls="faq13"><b>O que é registro de desenho industrial?</b></a>
          <div id="faq13" class="collapse p-4">
            <p>É um título de propriedade temporário concedido pelo Estado, por força de lei ao autor ou pessoas cujos
              direitos derivem do mesmo, para que esta ou estas excluam terceiros, durante o prazo de vigência do
              registro, sem sua prévia autorização, de atos relativos à matéria protegida, tais como fabricação,
              comercialização, importação, uso, venda, etc.</p>
            <p>No Brasil, desde a promulgação da Lei 9279 de 14 de maio de 1996, o Desenho Industrial é protegido
              através de registro e não de patente.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq14" role="button" aria-expanded="false"
            aria-controls="faq14"><b>O que é registrável como desenho industrial?</b></a>
          <div id="faq14" class="collapse p-4">
            <p>É registrável como desenho industrial a forma plástica ornamental de um objeto ou conjunto ornamental de
              linhas e cores que possa ser aplicado a um produto, proporcionando visual novo e original na sua
              configuração externa e que possa servir de tipo de fabricação industrial. Lembramos que a apresentação do
              pedido pode ser colorida, porém as cores não são protegidas, ou seja, a configuração ou o padrão
              ornamental será protegido independente das cores utilizadas.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq15" role="button" aria-expanded="false"
            aria-controls="faq15"><b>O que não pode ser protegido como registro?</b></a>
          <div id="faq15" class="collapse p-4">
            <p>Não pode ser passível de proteção os desenhos industriais que forem contrários à moral e aos bons
              costumes ou que ofenda a honra ou imagem de pessoas ou atente contra a liberdade de consciência, crença,
              culto religioso ou ideia e sentimentos dignos de respeito e veneração. Além disso, a forma necessária
              comum ou vulgar de um objeto, ou ainda, aquela determinada essencialmente por considerações técnicas ou
              funcionais também não são registráveis. Fica isento de registro de desenho industrial também os objetos ou
              padrões puramente artísticos, ou seja, que não podem ser reproduzidos em escala industrial.</p>
          </div>
          ...
          <div id="faq16" class="collapse p-4">
            <p>Basta falar com a gente para que seu pedido seja devidamente entendido e analisado, para que possamos
              apresentar ao INPI um dossiê com relatórios, reivindicações (caso haja) e desenhos, que devem estar dentro
              dos padrões estabelecidos pela normativa e Lei da Propriedade Intelectual.</p>
          </div>
          ...
          <div id="faq17" class="collapse p-4">
            <p>Qualquer pessoa física ou jurídica, desde que tenha legitimidade para obter o registro.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq18" role="button" aria-expanded="false"
            aria-controls="faq18"><b>Quais são os direitos conferidos ao titular do registro de desenho
              industrial?</b></a>
          <div id="faq18" class="collapse p-4">
            <p>O titular do desenho industrial tem o direito de impedir terceiros de produzir, colocar à venda, usar ou
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq19" role="button" aria-expanded="false"
            aria-controls="faq19"><b>Qual é o território de proteção do registro?</b></a>
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq20" role="button" aria-expanded="false"
            aria-controls="faq20"><b>É possível divulgar o desenho industrial em feiras, seminários e congressos antes
              de depositá-lo?</b></a>
          <div id="faq20" class="collapse p-4">
            <p>É recomendável depositar antes. Contudo, a lei permite a divulgação, desde que seja feita até 180 dias
              antes da entrada do pedido de registro de desenho industrial e que seja promovida pelo autor ou por
              terceiros com base em informações obtidas direta ou indiretamente do autor. Neste caso é possível
              declarar, no próprio formulário de depósito, as condições desta divulgação (Art. 12 e 96 da Lei de
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq21" role="button" aria-expanded="false"
            aria-controls="faq21"><b>Qual é a importância do registro de programa de computador?</b></a>
          <div id="faq21" class="collapse p-4">
            <p>Apesar de não ser obrigatório por lei, o registro de programa de computador é fundamental para comprovar
              a autoria de seu desenvolvimento perante o Poder Judiciário, podendo ser muito útil em casos de processos
              relativos à concorrência desleal, cópias não autorizadas, pirataria etc., garantindo, assim, maior
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq22" role="button" aria-expanded="false"
            aria-controls="faq22"><b>Tenho uma ideia de aplicativo para smartphone. Como faço para proteger minha ideia
              e meu aplicativo contra cópia?</b></a>
          <div id="faq22" class="collapse p-4">
            <p>A Lei de Direito Autoral (Lei nº 9.610/1998), e subsidiariamente a Lei de Software (Lei nº 9.609/1998),
            ...
            <p>Aqui vale uma ressalva: softwares apenas conceituais, ou seja, programas de computador que ainda se
              encontrem meramente no campo da ideia, não são passíveis de proteção.</p>
            <p>O registro do software no INPI é rápido, totalmente eletrônico, com a expedição do certificado em um
              prazo médio inferior a 7 dias.</p>
          </div>
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq24" role="button" aria-expanded="false"
            aria-controls="faq24"><b>Quem deve assinar o formulário eletrônico de depósito?</b></a>
          <div id="faq24" class="collapse p-4">
            <p>Para protocolar o pedido de registro, é necessária a assinatura digital do titular do direito e da Plure
              como seus procuradores (quando for o caso). Para estes casos é necessário que as assinaturas sejam
              digitais no padrão da ICP-Brasil, uma na procuração, do titular do direito, e outra no documento DV, do
              procurador.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq25" role="button" aria-expanded="false"
            aria-controls="faq25"><b>O que é o resumo digital hash?</b></a>
          <div id="faq25" class="collapse p-4">
            <p>O resumo hash é um texto de comprimento fixo contendo letras e números, que deve ser copiado e colado no
              campo correspondente do formulário eletrônico, juntamente com a identificação do algoritmo empregado para
              a sua geração conforme especificidades nas normativas do INPI. Este resumo fará parte do Certificado de
              Registro.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq26" role="button" aria-expanded="false"
            aria-controls="faq26"><b>Como faço para gerar o resumo hash?</b></a>
          <div id="faq26" class="collapse p-4">
            <p>A geração do resumo digital hash a partir da documentação técnica (código-fonte) pode se dar tanto sobre
            ...
            <p>Este trabalho é realizado por nós aqui na Plure, você pode ficar tranquilo. Para sua segurança, uma cópia
              íntegra do seu arquivo acima especificado pode ser mantida em nossa plataforma, caso seja solicitado em
              demandas judiciais ou pelo próprio INPI.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq27" role="button" aria-expanded="false"
            aria-controls="faq27"><b>Qual é o tempo de tramitação do pedido?</b></a>
          <div id="faq27" class="collapse p-4">
            <p>Protocolado o pedido de registro e consolidado o pagamento da GRU, o prazo para a expedição e
              disponibilização do certificado no portal do INPI é de até 10 dias corridos da data do depósito.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq28" role="button" aria-expanded="false"
            aria-controls="faq28"><b>Meu pedido ainda pode cair em exigência ou sofrer recurso?</b></a>
          <div id="faq28" class="collapse p-4">
            <p>Não, pois não existem mais as figuras da exigência e do recurso. Após protocolado o pedido de registro,
              apenas duas situações são possíveis: registro concedido ou petição não conhecida.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq29" role="button" aria-expanded="false"
            aria-controls="faq29"><b>De quem é a responsabilidade da guarda da documentação técnica sigilosa?</b></a>
          <div id="faq29" class="collapse p-4">
            <p>A guarda da documentação técnica (código-fonte) que compõe o pedido de registro não é mais de
              responsabilidade do INPI, mais sim do próprio interessado, isto é, o Titular do Direito. Ele será o
              responsável por garantir a sua perfeita integridade ao longo do tempo que for necessário.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq30" role="button" aria-expanded="false"
            aria-controls="faq30"><b>Ainda preciso pagar o valor do decênio?</b></a>
          <div id="faq30" class="collapse p-4">
            <p>Não. O registro permanece válido ao longo de todo o prazo de vigência, isto é, 50 anos, contados a partir
              de 1º de janeiro do ano subsequente ao da sua publicação ou, na ausência desta, da sua criação, sem a
              necessidade do pagamento de decênio.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq31" role="button" aria-expanded="false"
            aria-controls="faq31"><b>O registro do programa de computador só tem validade no território
              nacional?</b></a>
          <div id="faq31" class="collapse p-4">
            <p>Não. O registro de programa de computador não é territorial, isto é, sua abrangência é internacional,
              compreendendo os 175 países signatários da Convenção de Berna (1886).</p>
          </div>
          <hr>
          ...
          <div id="faq32" class="collapse p-4">
            <p>Além de proteger os seus ativos, é possível que você queira licenciá-los para uma empresa, ou então obter
              uma licença para impulsionar seu negócio. Pode ainda preferir adquirir conhecimentos não amparados por
              direitos de propriedade industrial. Para que estas transações sejam seguras e permitam a realização do
              pagamento ao exterior, existem contratos que devem ser averbados e/ou registrados no INPI.</p>
            <p>Os tipos de contratos existentes são as cessões e os licenciamentos de patentes, desenhos industriais e
              marcas, além de assistência técnica e do fornecimento de tecnologia (know-how). Também são registradas as
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq33" role="button" aria-expanded="false"
            aria-controls="faq33"><b>Quais são os tipos de contratos que o INPI averba ou registra?</b></a>
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq34" role="button" aria-expanded="false"
            aria-controls="faq34"><b>Quais são os efeitos da averbação?</b></a>
          <div id="faq34" class="collapse p-4">
            <p>Legitimar remessas de divisas ao exterior, como pagamento pela tecnologia negociada; Permitir
              dedutibilidade fiscal, quando for o caso, para a empresa receptora da tecnologia das importâncias pagas a
              título de royalties e assistência técnica; Produzir efeitos perante terceiros.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq35" role="button" aria-expanded="false"
            aria-controls="faq35"><b>Como é definido o valor contratual?</b></a>
          <div id="faq35" class="collapse p-4">
            <p>Nos contratos de licenciamento de patente, desenho industrial e marca os tipos de pagamento usualmente
              negociados são: percentual incidente sobre o preço líquido de venda e valor fixo por unidade vendida; nos
              de fornecimento de tecnologia a remuneração é estabelecida de acordo com a negociação contratual, devendo
              ser levado em conta os níveis de preços praticados nacional e internacionalmente em contratações
              similares.</p>
            <p>Já nos contratos de serviços de assistência técnica será exigida a explicitação do custo em função da
              taxa dia/hora detalhado por especialização do técnico e o valor total do serviço, ainda que estimado. Nos
              contratos de franquia a remuneração usualmente estipulada é: taxa de franquia, taxa de royalties
              (percentual sobre o preço líquido de venda ou do faturamento); taxa de publicidade, além de outras taxas.
            </p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq36" role="button" aria-expanded="false"
            aria-controls="faq36"><b>É obrigatório o registro do contrato de franquia no INPI?</b></a>
          <div id="faq36" class="collapse p-4">
            <p>O registro é necessário para os contratos cujos franqueadores são domiciliados no exterior e estabelecem
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq37" role="button" aria-expanded="false"
            aria-controls="faq37"><b>Qual lei rege o sistema de franquia e o que é Circular de Oferta?</b></a>
          <div id="faq37" class="collapse p-4">
            <p>A Lei nº 13.966, de 26 de dezembro de 2019, rege o sistema de franquia.</p>
            <p>A Circular de Ofertas constitui uma das exigências da Lei Brasileira, 13.966 (artigo 2º), exige que o
              franqueador entregue ao franqueado dez (10) dias antes da assinatura do contrato definitivo para análise.
              Neste documento deverá constar o histórico resumido da empresa, balanços e demonstrações financeiras da
              empresa, perfil do "franqueado ideal", situação perante o Instituto Nacional da Propriedade Industrial -
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq38" role="button" aria-expanded="false"
            aria-controls="faq38"><b>A marca é importante no sistema de franquia?</b></a>
          <div id="faq38" class="collapse p-4">
            <p>Sim. A marca é o maior patrimônio do franqueador.</p>
            <p>No sistema de franquia, assim como no sistema unitário, a marca é a propaganda do negócio. Ela é o elo da
              rede de franquia. É bom lembrar que uma falha do franqueado afetará toda a rede, assim como a marca.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq39" role="button" aria-expanded="false"
            aria-controls="faq39"><b>Quem pode requerer averbação?</b></a>
          ...
          <a class="faqBtn" data-bs-toggle="collapse" href="#faq40" role="button" aria-expanded="false"
            aria-controls="faq40"><b>Qual é a documentação a ser apresentada em um pedido de averbação?</b></a>
          <div id="faq40" class="collapse p-4">
            <p>Para solicitar o serviço, o requisitante deve providenciar os seguintes documentos: Formulário de
              requerimento de averbação (devidamente preenchido); Guia de Recolhimento da União (GRU) - paga;
              Procuração; Carta explicativa; Contrato e aditivo ou fatura; Traduções (de toda documentação em língua
              estrangeira); e Ficha de cadastro da(s) Empresa(s) Cessionária(s) Brasileira(s).</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq41" role="button" aria-expanded="false"
            aria-controls="faq41"><b>Qual o tempo de tramitação para decisão do INPI?</b></a>
          <div id="faq41" class="collapse p-4">
            <p>30 dias, a contar da data de publicação da petição ou pedido de averbação na RPI, conforme Artigo 211,
              parágrafo único, Lei nº 9.279 de 14/05/96.</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq42" role="button" aria-expanded="false"
            aria-controls="faq42"><b>Quais são os serviços que não são caracterizados como transferência de
              tecnologia?</b></a>
          <div id="faq42" class="collapse p-4">
            <p>Por não caracterizarem transferência de tecnologia, nos termos do Art. 211 da Lei nº 9.279/96 alguns
              serviços técnicos especializados são dispensados de averbação pelo INPI. Segue lista não exaustiva desses
              serviços:</p>
            <p>Agenciamento de compras, incluindo serviços de logística (suporte ao embarque, tarefas administrativas
              relacionadas à liberação alfandegária, etc.); Serviços realizados no exterior sem a presença de técnicos
              da empresa brasileira, que não gerem quaisquer documentos e/ou relatórios, como por exemplo,
              beneficiamento de produtos; Homologação e certificação de qualidade de produtos; Consultoria na área
              financeira; Consultoria na área comercial; Consultoria na área jurídica; Consultoria visando participação
              em licitação; Serviços de marketing; Consultoria remota, sem a geração de documentos; Serviços de suporte,
              manutenção, instalação, implementação, integração, implantação, customização, adaptação, certificação,
              migração, configuração, parametrização, tradução, ou localização de programa de computador (software);
              Serviços de treinamento para usuário final ou outro treinamento de programa de computador (software);
              Licença de uso de programa de computador (software); Distribuição de programa de computador (software);
              Aquisição de cópia única de programa de computador (software).</p>
          </div>

          <a class="faqBtn" data-bs-toggle="collapse" href="#faq43" role="button" aria-expanded="false"
            aria-controls="faq43"><b>Como fazer para realizar os pagamentos ao exterior decorrentes das aprovações dos
          ...
          <div id="faq43" class="collapse p-4">
            <p>Para remeter moeda estrangeira como pagamento que envolva direitos de propriedade industrial,
              fornecimento de tecnologia, prestação de serviços de assistência técnica e franquia é necessário que a
              empresa formalize um contrato e o submeta a averbação do INPI.</p>
            <p>Após a emissão do respectivo Certificado de Averbação a empresa poderá, de acordo com a Resolução BACEN
              nº 3.844/2010 e Regulamento anexo III, proceder ao Registro Declatório Eletrônico - Registro de Operação
              Financeira (RDE/ROF) por transferência de tecnologia, acessando o SISBACEN, por intermédio de uma
              instituição financeira ou por meios próprios.</p>
          </div>
