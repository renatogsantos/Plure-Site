...
<html lang="en">
  ...
  <?php wp_head(); ?>
    ...
    />
    <link rel="stylesheet" href="<?php  echo get_theme_root_uri(); ?>/plure/style.css" />
  ...
  <body>
    ...
    <section>
      <img class="wave" src="<?php  echo get_theme_root_uri(); ?>/plure/assets/wave.svg" alt="curvas">
      <div class="container-fluid py-5 hero2">
        <div class="container py-5">
          <div id="cards" class="row"></div>
        </div>
      </div>
      <img class="wave2" src="<?php  echo get_theme_root_uri(); ?>/plure/assets/wave2.svg" alt="curvas">
    </section>
        ...
        <div class="container py-5">
          <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-4 col-lg-3">
              <img class="shake-vertical" width="100%" src="<?php  echo get_theme_root_uri(); ?>/plure/assets/draw2.svg" alt="" srcset="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container py-5">
          ...
          <div class="row">
            <div class="col-12 col-sm-12 col-md-4">
              <img class="shake-vertical" width="100%" src="<?php  echo get_theme_root_uri(); ?>/plure/assets/girl.png" alt="Mulher feliz apontando para a direita">
            </div>
          ...
          <div class="cardBox">
            <div class="row">
              <div class="col-12 col-sm-12 col-md-12 col-lg-4 d-flex align-items-center justify-content-center">
                <img class="girl2" src="<?php  echo get_theme_root_uri(); ?>/plure/assets/girl2.png" alt="Mulher ruiva triste">
              </div>
    ...
    <section>
      ...
      <div class="container-fluid py-5 hero2 text-center">
        <div class="container py-5">
          <img class="mb-5" width="300px" src="<?php  echo get_theme_root_uri(); ?>/plure/assets/draw3.svg" alt="Desenho de dois bonecos segurando um símbolo de interrogação" srcset="">
          <br>
    ...
    <script src="<?php  echo get_theme_root_uri(); ?>/plure/typed.min.js"></script>
    <script src="<?php  echo get_theme_root_uri(); ?>/plure/global.js"></script>
    <script
